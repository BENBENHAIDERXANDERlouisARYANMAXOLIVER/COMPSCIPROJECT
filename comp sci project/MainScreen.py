...
class MainFrame(tk.Frame):
    def __init__(self, parent):
     ...
     #settings test button
        settingsbutton=tk.Button(self, text="Settings",bg="#CCCCCC",fg="black", font="Georgia", activebackground="black",relief="groove", activeforeground="#CCCCCC",command=self.parent.switchtosettings)
