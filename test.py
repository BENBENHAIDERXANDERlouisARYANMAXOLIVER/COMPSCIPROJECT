...
#database initialisatiion
    c.execute("CREATE TABLE tblQuestions (Questionimg TEXT,TopicName TEXT, Answer TEXT, QuestionID INTEGER PRIMARY KEY AUTOINCREMENT, Hints TEXT, ModelAnswer TEXT)")
    c.execute("INSERT INTO tblQuestions(Questionimg ,TopicName, Answer, Hints, ModelAnswer) Values (?,?,?,?,?)", ("Test","ASTRO","lightyear", "NOHINT", "TESTVALUE"))
    db.commit()
